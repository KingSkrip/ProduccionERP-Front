...
export class SharedDataService {
  ...
  // ── Tejido por día ──
  private datosTejidoPorDiaSource = new BehaviorSubject<any[]>([]);
  datosTejidoPorDia$ = this.datosTejidoPorDiaSource.asObservable();
  actualizarTejidoPorDia(datos: any[]): void {
    this.datosTejidoPorDiaSource.next(datos);
  }

  // ── Tintorería por día ──
  private datosTintoreriaPorDiaSource = new BehaviorSubject<any[]>([]);
  datosTintoreriaPorDia$ = this.datosTintoreriaPorDiaSource.asObservable();
  actualizarTintoreriaPorDia(datos: any[]): void {
    this.datosTintoreriaPorDiaSource.next(datos);
  }

  // ── Estampado por día ──
  private datosEstampadoPorDiaSource = new BehaviorSubject<any[]>([]);
  datosEstampadoPorDia$ = this.datosEstampadoPorDiaSource.asObservable();
  actualizarEstampadoPorDia(datos: any[]): void {
    this.datosEstampadoPorDiaSource.next(datos);
  }

  // ── Acabado por día ──
  private datosAcabadoPorDiaSource = new BehaviorSubject<any[]>([]);
  datosAcabadoPorDia$ = this.datosAcabadoPorDiaSource.asObservable();
  actualizarAcabadoPorDia(datos: any[]): void {
    this.datosAcabadoPorDiaSource.next(datos);
  }
