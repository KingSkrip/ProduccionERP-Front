...
@Component({
  selector: 'composer-tintoreria',
  templateUrl: './composertintoreria.component.html',
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
...
export class ComposerTintoreriaComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private _dialogRef: MatDialogRef<ComposerTintoreriaComponent>,
  ...
  ngOnInit(): void {
    ...
    setTimeout(() => {
      this._reportService
        .getTintoreriaPorDia(fechaInicio, fechaFin)
