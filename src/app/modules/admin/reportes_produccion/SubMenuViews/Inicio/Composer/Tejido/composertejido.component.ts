...
import { ReportProdService } from 'app/modules/admin/reportes_produccion/reportprod.service';
...
@Component({
  selector: 'composer-tejido',
  templateUrl: './composertejido.component.html',
  standalone: true,
  imports: [
...
export class ComposerTejidoComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private _dialogRef: MatDialogRef<ComposerTejidoComponent>,
  ...
  ngOnInit(): void {
    ...
    setTimeout(() => {
      this._reportService.getTejidoPorDia(fechaInicio, fechaFin)
