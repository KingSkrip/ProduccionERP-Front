...
@Component({
  selector: 'app-checador-colab',
  standalone: true,
  imports: [CommonModule, MatIconModule],
  templateUrl: './checador-colab.component.html',
  styleUrls: ['./checador-colab.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ChecadorColabComponent implements AfterViewInit, OnDestroy {
