...
import { EmpleadoE1 } from '../../../usuarios.types';
...
export class ColaboradorListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    displayedColumns: string[] = ['CLAVE', 'NOMBRE', 'AP_PAT_', 'AP_MAT_', 'actions'];

    searchInputControl: UntypedFormControl = new UntypedFormControl('');
    private _unsubscribeAll: Subject<any> = new Subject<any>();

    dataSource = new MatTableDataSource<EmpleadoE1>([]);
    EmpleadoE1$: Observable<EmpleadoE1[]>;
    ...
    ngOnInit(): void {
        ...
        // Observable de empleados
        this.EmpleadoE1$ = this._inventoryService.empleadosE1$;

        // Inicializa cargando empleados
        this._inventoryService.getEmpleadosE1(0, 200)
    ...
    get paginatedEmpleados(): EmpleadoE1[] {
    ...
    // toggleDetails(usuario: EmpleadoE1): void {
