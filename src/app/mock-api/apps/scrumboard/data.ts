...
export const boards = [
  {
    ...
    description: 'Hoja de ruta para el nuevo proyecto',
  ...
  },
  {
    ...
    description: 'Tareas laborales de la semana',
  ...
  },
  {
    ...
    description: 'Tareas personales en casa',
...
export const cards = [
  {
    ...
    position: 65536,
    title:
      'Ejemplo que muestra todas las opciones disponibles en la tarjeta con un título bastante largo en comparación con otras tarjetas',
    description:
      'Ejemplo que muestra todas las opciones disponibles en la tarjeta con un título bastante largo en comparación con otras tarjetas. Ejemplo que muestra todas las opciones disponibles en la tarjeta con un título bastante largo en comparación con otras tarjetas.',
    labels: [
  ...
  },
  {
    ...
    listId: 'a2df7786-519c-485a-a85f-c09a61cc5f37',
    position: 131072,
    title: 'Investigar las aplicaciones administrativas más necesarias',
  ...
  },
  {
    ...
    listId: 'a2df7786-519c-485a-a85f-c09a61cc5f37',
    position: 196608,
    title: 'Implementar el panel del proyecto',
  ...
  },
  {
    ...
    listId: 'a2df7786-519c-485a-a85f-c09a61cc5f37',
    position: 262144,
    title: 'Implementar el panel de analíticas',
    labels: ['caff9c9b-a198-4564-b1f4-8b3df1d345bb'],
  ...
  },
  {
    ...
    position: 65536,
    title: 'Diseño del panel de analíticas',
  ...
  },
  {
    ...
    listId: '83ca2a34-65af-49c0-a42e-94a34003fcf2',
    position: 131072,
    title: 'Diseño del panel del proyecto',
    labels: ['e8364d69-9595-46ce-a0f9-ce428632a0ac'],
    dueDate: null,
  },
  {
  ...
  },
  {
    ...
    position: 65536,
    title: 'Crear wireframes de baja fidelidad',
    labels: [],
    dueDate: null,
  },
  {
    ...
    listId: '34cbef38-5687-4813-bd66-141a6df6d832',
    position: 131072,
    title: 'Crear wireframes de alta fidelidad',
    labels: [],
    dueDate: now.startOf('day').minus({ day: 10 }).toISO(),
  },
  {
    ...
    listId: '34cbef38-5687-4813-bd66-141a6df6d832',
    position: 196608,
    title: 'Recolectar información sobre los layouts administrativos más usados',
    labels: ['e0175175-2784-48f1-a519-a1d2e397c9b3'],
    dueDate: null,
  },
  {
    ...
    listId: '34cbef38-5687-4813-bd66-141a6df6d832',
    position: 262144,
    title: 'Investigar las últimas tendencias de UI',
    labels: ['e0175175-2784-48f1-a519-a1d2e397c9b3'],
    dueDate: null,
  },
  {
